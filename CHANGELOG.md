...
All notable changes to The Another Multi-Domain Global Styles are documented here.
...
### Added
- Initial release.
- `mdgs_brand` custom post type as the Brand aggregate root, gated behind the `edit_theme_options` capability.
...
[Unreleased]: https://github.com/theanother/the-another-multi-domain-global-styles/compare/v0.1.0...HEAD
[0.1.0]: https://github.com/theanother/the-another-multi-domain-global-styles/releases/tag/v0.1.0
