 ...
 * Requires PHP: 8.3
 * Text Domain: the-another-multi-brand-global-styles
...
define( 'THE_ANOTHER_MULTI_BRAND_GLOBAL_STYLES_VERSION', '0.2.0' );
...
define( 'THE_ANOTHER_MULTI_BRAND_GLOBAL_STYLES_PLUGIN_BASENAME', plugin_basename( __FILE__ ) );
	...
	add_action(
		...
		function () {
			...
			<div class="notice notice-error">
				<p><?php echo esc_html__( 'The Another Multi-Brand Global Styles requires PHP 8.3 or higher. Please upgrade your PHP version.', 'the-another-multi-brand-global-styles' ); ?></p>
			</div>
			<?php
		}
	);
...
if ( version_compare( get_bloginfo( 'version' ), '6.9', '<' ) ) {
	add_action(
		...
		function () {
			?>
			<div class="notice notice-error">
				<p><?php echo esc_html__( 'The Another Multi-Brand Global Styles requires WordPress 6.9 or higher. Please upgrade WordPress.', 'the-another-multi-brand-global-styles' ); ?></p>
			</div>
			<?php
		}
	);
...
if ( file_exists( THE_ANOTHER_MULTI_BRAND_GLOBAL_STYLES_PLUGIN_DIR . 'vendor/autoload.php' ) ) {
	...
	function () {
		try {
			...
			wp_die(
				...
				esc_html__( 'Multi-Brand Global Styles Error', 'the-another-multi-brand-global-styles' ),
				array( 'response' => 500 )
			);
		}
	}
